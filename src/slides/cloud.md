...
A l'échelle des applications, **respecter [les 12 facteurs](https://mborne.github.io/devops/12-facteurs/)** mis en avant par [Heroku](https://www.heroku.com/) sera un bon point de départ pour :
