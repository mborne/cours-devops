...
Surtout, dans le cadre de ce cours, nous remarquerons que l'API Kubernetes permet de **séparer les responsabilités entre les DEV et les OPS** (à comparer avec l'approche IaaS de la partie précédente)
