...
Les mécanismes d'isolation ne sont pas nouveaux dans le noyau Linux (voir [Linux namespaces (2002-2007)](https://mborne.github.io/outils/linux/namespace/), [cgroups (2006-2008)](https://fr.wikipedia.org/wiki/Cgroups) et [LXC - LinuX Containers (2008-2010)](https://fr.wikipedia.org/wiki/LXC)). [Les systèmes de fichiers par couches non plus](https://www.adaltas.com/fr/2021/06/03/linux-overlay-filesystem-docker/).
...
- Des images pour des services : [postgres](https://hub.docker.com/_/postgres), [mongodb](https://hub.docker.com/u/mongodb), [redis](https://hub.docker.com/_/redis),...
...
En particulier, il vous faudra potentiellement traiter ceux liés à l'[utilisation d'un proxy sortant avec docker](https://mborne.github.io/devops/proxy-sortant/proxy-docker/).
