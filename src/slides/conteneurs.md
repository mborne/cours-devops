...
* La présence d'un commande [docker logs](https://docs.docker.com/engine/reference/commandline/logs/) permettant de récupérer les journaux applicatifs d'un conteneur

Il sera bien sûr toujours possible d'écrire des journaux dans des fichiers mais se conformer à la [11ième recommandation sur Logs des 12 facteurs](https://12factor.net/fr/logs) en écrivant les messages dans les flux standards simplifiera la collecte de ces derniers.
