...
Nous survolerons l'annexe [Kubernetes - les volumes et le stockage](https://mborne.github.io/outils/kubernetes/stockage/) pour constater que **Kubernetes offre de nombreuses possibilités en matière de stockage** mais que **c'est un sujet complexe**.
...
Voir [mborne/geostack-deploy - k8s - Déploiement de GeoStack avec Kubernetes](https://github.com/mborne/geostack-deploy/tree/master/k8s)
...
Il est toutefois du ressort de l'utilisateur d'exploiter ce cadre en **respectant un ensemble de [bonnes pratiques](https://mborne.github.io/outils/docker/bonnes-pratiques/) dans la création et l'exécution des conteneurs** pour profiter d'un bon niveau de sécurité et d'un haut niveau de disponibilité (1).
