...
La virtualisation gagnera en popularité auprès des développeurs grâce à la sortie de logiciel gratuit tels [VirtualBox](https://www.virtualbox.org/) (2007) supportant les architectures x86 :
...
<div class="center">
    <img src="img/virtualisation-app.png" alt="Virtualisation des applications" style="height: 350px" />
</div>

Nous soulignerons qu'il est possible d'héberger **plusieurs applications sur une même VM**. Nous constaterons que ceci implique un **partage des bibliothèques systèmes**.
