...
On reconnaîtra dans ce processus la **roue de Deming** bien connue dans le **domaine de la qualité et l'agilité** :
...
* Il fallait croiser les doigts pour que la procédure de déploiement soit à jour.
...
Il sera souvent nécessaire de revoir [la gestion du cycle de vie des applications (ALM)](https://www.redhat.com/fr/topics/devops/what-is-application-lifecycle-management-alm) pour :
