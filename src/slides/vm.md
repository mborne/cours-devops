...
Nous nous contenterons de survoler quelques exemples et de souligner que **Terraform n'est pas stateless** ce qui induit qu'il faut :

* [Configurer un backend pour le stockage de l'état du système](https://www.terraform.io/language/settings/backends/configuration))
* Se méfier des conflits possibles entre l'utilisation de terraform et des interfaces graphiques des fournisseurs (ex : console OVHCloud)
