...
* Kubernetes va un cran plus loin en permettant par exemple aux équipes applicatives de spécifier la configuration du LoadBalancer avec le concept [Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/#what-is-ingress) plutôt que via un ticket ou un document.
