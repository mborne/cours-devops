...
* Les [conteneurs](conteneurs.md) qui solutionnent ce **problème de partage de responsabilité** en embarquant les dépendances des applications dans les images (1).
* [Kubernetes](kubernetes.md) traite ces problèmes de **partage de responsabilité à l'échelle d'une zone d'hébergement** par exemple en **cloisonnant les applications** (concept *Namespace*) et en permettant aux équipes applicatives de **spécifier les URL externes** (concept *Ingress* pour la configuration du LoadBalancer).

> (1) Je passerai sous silence la possibilité de fournir des images de VM applicative complète avec des outils tels [Packer](https://www.packer.io/) ou de simples fichiers [cloud-init](https://cloud-init.io/).
